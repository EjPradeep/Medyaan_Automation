exports.Refund = class Refund {
   ...
   async AllTab() {
    ...
    async Checkbox(Id, name, product, amount) {
        ...
        const checkbox1 = this.page.locator(`//div[@col-id="amount" and contains(translate(normalize-space(.), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), '${samount}')]/preceding-sibling::div[@col-id='productname' and contains(translate(normalize-space(.), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), '${sproduct}')]/preceding-sibling::div[@col-id='customername' and contains(translate(normalize-space(.), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), '${sname}')]/preceding-sibling::div[@col-id='0']/div/div/div/child::div/input`)
        ...
        const checkbox3 = this.page.locator(`//div[@col-id='productname' and contains(translate(normalize-space(.), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), '${sproduct}')]/preceding-sibling::div[@col-id='customername' and contains(translate(normalize-space(.), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), '${sname}')]/preceding-sibling::div[@col-id='0']/div/div/div/child::div/input`)
